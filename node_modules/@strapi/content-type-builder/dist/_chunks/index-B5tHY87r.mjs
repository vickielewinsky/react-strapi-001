...
const ListView$1 = lazy(() => import("./ListView-B7k6NgwS.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-B7k6NgwS.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-B5tHY87r.mjs.map
