...
const admin = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => Promise.resolve().then(() => require("./App-DNScJAhi.js")).then((mod) => ({ default: mod.Upload })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await Promise.resolve().then(() => require("./SettingsPage-CrvbJCia.js"));
...
//# sourceMappingURL=index-BfAVIhAL.js.map
