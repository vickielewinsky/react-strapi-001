...
import { c as useTracking, t as capitalise, m as useGuidedTour, u as useAuth, P as Page } from './Theme-CTMU9Z8I.mjs';
...
const HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import('./HomePage-DPgihdwp.mjs')).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=HomePage-CysC5L5a.mjs.map
