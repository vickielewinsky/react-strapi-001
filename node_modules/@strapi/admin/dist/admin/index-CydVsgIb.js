  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await Promise.resolve().then(() => require('./ListPage-DysJaP5_.js'));
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await Promise.resolve().then(() => require('./SingleSignOnPage-BTbCQg8m.js'));
        return {
...
const AuthPage = () => {
  ...
  const Login$1 = useEnterprise.useEnterprise(
    Login,
    async () => (await Promise.resolve().then(() => require('./Login-Dtjgq7f1.js'))).LoginEE
  );
  const forms = useEnterprise.useEnterprise(
    FORMS,
    async () => (await Promise.resolve().then(() => require('./constants-DJL6QsIz.js'))).FORMS,
    {
...
const ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await Promise.resolve().then(() => require('./ListPage-BuglugGG.js'));
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await Promise.resolve().then(() => require('./CreatePage-C6UdEQOs.js'));
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require('./EditPage-D69Hx_ec.js'));
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await Promise.resolve().then(() => require('./ListPage-BLWQxrOV.js'));
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require('./EditPage-CSFYt_HC.js'));
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await Promise.resolve().then(() => require('./CreatePage-CbJkyfCM.js'));
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require('./EditPage-BBZ7R3in.js')).then(n => n.EditPage$1);
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await Promise.resolve().then(() => require('./ListPage-Db_wvfYm.js'));
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await Promise.resolve().then(() => require('./ListView-BdD6RHIQ.js'));
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await Promise.resolve().then(() => require('./CreateView-B39tI8E1.js'));
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await Promise.resolve().then(() => require('./EditViewPage-CtBSUjNT.js'));
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await Promise.resolve().then(() => require('./CreateView-COaAIHM0.js'));
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await Promise.resolve().then(() => require('./ListView-CBYpU5Jy.js'));
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await Promise.resolve().then(() => require('./EditView-DXCpjmO7.js'));
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await Promise.resolve().then(() => require('./InstalledPlugins-CZ0iNNcI.js'));
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await Promise.resolve().then(() => require('./PurchaseAuditLogs-DXQrXdue.js'));
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await Promise.resolve().then(() => require('./PurchaseSingleSignOn-CH-Lyjo5.js'));
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await Promise.resolve().then(() => require('./PurchaseContentHistory-jwPqZsuh.js'));
      return {
...
const getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await Promise.resolve().then(() => require('./UseCasePage-BZYK5NSZ.js'));
      return {
...
const getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await Promise.resolve().then(() => require('./HomePage-kmMq4BVh.js'));
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await Promise.resolve().then(() => require('./ProfilePage-B04OT5Fd.js'));
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await Promise.resolve().then(() => require('./MarketplacePage-CJLsg0_U.js'));
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await Promise.resolve().then(() => require('./Layout-BVOfyAt_.js'));
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await Promise.resolve().then(() => require('./ApplicationInfoPage-C5uFIQZ2.js'));
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await Promise.resolve().then(() => require('./AuthenticatedLayout-BGC6wyzT.js'));
              return {
  ...
  async loadAdminTrads() {
    const adminLocales = await Promise.all(
      this.configurations.locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper((/* #__PURE__ */ Object.assign({"./translations/en-GB.js": () => Promise.resolve().then(() => require('./en-GB-BHA-Obg7.js'))})), `./translations/${locale}.js`, 3);
          return { data, locale };
        } catch {
          try {
            const { default: data } = await __variableDynamicImportRuntimeHelper((/* #__PURE__ */ Object.assign({"./translations/ar.json": () => Promise.resolve().then(() => require('./ar-CzJtN9ZR.js')),"./translations/ca.json": () => Promise.resolve().then(() => require('./ca-BQmZwkyJ.js')),"./translations/cs.json": () => Promise.resolve().then(() => require('./cs-DeS9DzIq.js')),"./translations/de.json": () => Promise.resolve().then(() => require('./de-CxVS71Os.js')),"./translations/dk.json": () => Promise.resolve().then(() => require('./dk-B-52bH2A.js')),"./translations/en.json": () => Promise.resolve().then(() => require('./en-aGYWBxXH.js')),"./translations/es.json": () => Promise.resolve().then(() => require('./es-D3FlHFx3.js')),"./translations/eu.json": () => Promise.resolve().then(() => require('./eu-DIDTb1Xq.js')),"./translations/fr.json": () => Promise.resolve().then(() => require('./fr-DrIHgYTT.js')),"./translations/gu.json": () => Promise.resolve().then(() => require('./gu-Hc5YzUuw.js')),"./translations/he.json": () => Promise.resolve().then(() => require('./he-jthbtjhf.js')),"./translations/hi.json": () => Promise.resolve().then(() => require('./hi-Dd3AL7Vo.js')),"./translations/hu.json": () => Promise.resolve().then(() => require('./hu-Dy6tJonx.js')),"./translations/id.json": () => Promise.resolve().then(() => require('./id-BX77nhRG.js')),"./translations/it.json": () => Promise.resolve().then(() => require('./it-BFsCRAiv.js')),"./translations/ja.json": () => Promise.resolve().then(() => require('./ja-DeeXToB8.js')),"./translations/ko.json": () => Promise.resolve().then(() => require('./ko-DQ16dRok.js')),"./translations/ml.json": () => Promise.resolve().then(() => require('./ml-D3lcQ9Qh.js')),"./translations/ms.json": () => Promise.resolve().then(() => require('./ms-C-JB0-h1.js')),"./translations/nl.json": () => Promise.resolve().then(() => require('./nl-DN7knmKC.js')),"./translations/no.json": () => Promise.resolve().then(() => require('./no-B9qB0rWa.js')),"./translations/pl.json": () => Promise.resolve().then(() => require('./pl-CdJxEUSA.js')),"./translations/pt-BR.json": () => Promise.resolve().then(() => require('./pt-BR-DBqyMlGp.js')),"./translations/pt.json": () => Promise.resolve().then(() => require('./pt-CEcd6cjN.js')),"./translations/ru.json": () => Promise.resolve().then(() => require('./ru-Dwf09uUc.js')),"./translations/sa.json": () => Promise.resolve().then(() => require('./sa-DDD2kxvP.js')),"./translations/sk.json": () => Promise.resolve().then(() => require('./sk-CbJVofN-.js')),"./translations/sv.json": () => Promise.resolve().then(() => require('./sv-BqRXfruc.js')),"./translations/th.json": () => Promise.resolve().then(() => require('./th-CPx6wf0M.js')),"./translations/tr.json": () => Promise.resolve().then(() => require('./tr-D8gIyQxv.js')),"./translations/uk.json": () => Promise.resolve().then(() => require('./uk-DHmepDW6.js')),"./translations/vi.json": () => Promise.resolve().then(() => require('./vi-UeRpPdvI.js')),"./translations/zh-Hans.json": () => Promise.resolve().then(() => require('./zh-Hans-B34a3f93.js')),"./translations/zh.json": () => Promise.resolve().then(() => require('./zh-AMwNTzOa.js'))})), `./translations/${locale}.json`, 3);
            return { data, locale };
          } catch {
...
//# sourceMappingURL=index-CydVsgIb.js.map
