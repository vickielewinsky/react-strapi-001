...
import { e as errorsTrads, j as useUpdateUserMutation, k as useAdminUsers, F as Form, b as Layouts, B as BackButton, M as MemoizedInputRenderer } from './index-BSJxpmc1.mjs';
import { b as useTypedSelector, P as Page, a as useNotification, e as useAPIErrorHandler, k as useRBAC } from './Theme-CTMU9Z8I.mjs';
...
import { M as MagicLinkCE, S as SelectRoles } from './SelectRoles-pO8L3L4W.mjs';
import { C as COMMON_USER_SCHEMA } from './validation-BUsrO5hO.mjs';
...
const EditPage = () => {
  ...
  const MagicLink = useEnterprise(
    MagicLinkCE,
    async () => (await import('./MagicLinkEE-CtnFDrz0.mjs')).MagicLinkEE
  );
  const {
...
//# sourceMappingURL=EditPage-D-DXDPnf.mjs.map
